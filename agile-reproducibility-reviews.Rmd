---
title: "Reproducibility Review AGILE 2025"
...
This document includes scripts and text analysis to support the reproducibility review at the [AGILE conference 2025](https://agile-gi.eu/conference-2025), which is organised by the team of the Chair for Geoinformatics, TU Dresden, Germany.
...
The code of this document is published on GitHub in the repository [reproducible-agile/reviews-2025](https://github.com/reproducible-agile/reviews-2025), where you can inspect the R code in the file `agile-reproducibility-reviews.Rmd` and find instructions for reproducing the workflow.
...
# get this from the URL when logged into EasyChair, e.g., https://easychair.org/conferences/submissions?a=34091123
conference_id <- "33640409"
```
...
The main outcome of the reviews is a _report_, which is published in individual OSF projects as components of the [OSF project for the reproducibility reviews 2025](https://osf.io/t8qw5/).
...
2. Take a look at the [RMarkdown review report template](https://github.com/reproducible-agile/reviews-2025/blob/master/report-template/reproreview-template.Rmd) - even if you're not using it, it gives you guidance on structure and content, you are welcome to write your report with any tool that can produce a PDF
3. Go to the [shared spreadsheet reproducibility reviewers](https://docs.google.com/spreadsheets/d/1q_oOQtv0m5gsKpCtTLhgyfbEMOBCC3dFw6M00mzyNYc/edit?gid=1766356109#gid=1766356109) and find your assignments
...
7. Add a new component to the [OSF project for 2025 reproducibility reviews](https://osf.io/t8qw5/) *OR* create a new module on [ResearchEquals](https://www.researchequals.com)
    - **On OSF**
    ...
    - **On ResearchEquals**
        ...
        - Add the reproducibility report as the main file
...
8. _After_ papers are published:
    ...
    - On OSF
        - Mint a DOI (double check if it is correct in the report)
...
1. After report publication
    ...
    - "Archive" the projects on GitHub so that they becomee read-only ([instructions GitHub](https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/about-archiving-repositories), [instructions for GitLab](https://docs.gitlab.com/ee/user/project/settings/#archiving-a-project))
...
Congratulations to the acceptance of your submission "TITLE" as a full paper at the AGILE conference 2025.

As part of the Reproducible AGILE initative (https://reproducible-agile.github.io/) I attempted to reproduce the results from your paper. Attached to this email you find my report on your results. I welcome your feedback before I publish the report.
The reproducibility report will be published soon after the papers is published by Copernicus, so we can ensure proper linking of your work in the report (using a DOI) and vice versa.
