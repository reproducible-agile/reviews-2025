...
1. **_After_ papers are published:**
    - Upload the report as a single PDF document and supplemental material created by you
    - Upload, if suitable, also the original material (add `LICENSE.md` and licensing information in the OSF project description in that case)
    ...
    - **On OSF**
        ...
        - Create an "Open-ended" registration to snapshot the status of the OSF component/project
